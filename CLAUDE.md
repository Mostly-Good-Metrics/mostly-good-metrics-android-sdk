...
3. CI automatically publishes to JitPack and creates a GitHub release

**DO NOT:**
- Manually edit version in `build.gradle` or `gradle.properties`
- Manually publish to JitPack/Maven
